                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-blue">
                                <div class="card-head">
                                    <header>HISTORIAL CLIENTES</header>
                                </div>
                                <div class="card-body ">
                                        ...
                                        <table class="table table-striped custom-table ">
                                            ...
                                            <tbody><?php foreach($resultado as $fila):?>
                                                <tr >
                                                    ...
                                                    <td><?php echo $fila['usuario_v']; ?></td>
                                                    <td><?php echo $fila['contrasena_v']; ?></td>
                                                    <td><a href="clientesUpdate.php?id_cliente=<?php echo $fila['id_cliente']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa fa-pencil"></i></a></td>
                                                    <td><a href="clientesDelete.php?id_cliente=<?php echo $fila['id_cliente']; ?>" class="btn btn-danger btn-xs btn__delete"><i class="fa fa-trash-o "></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
