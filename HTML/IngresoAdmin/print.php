...
h1 { font: bold 100% sans-serif; letter-spacing: 0.5em; text-align: center; text-transform: uppercase; background-color:  #1F618D;}
...
header h1 { background: #000; border-radius: 0.25em; color: #FFF; margin: 0 0 1em; padding: 0.5em 0; background-color:  #1F618D;}
header address { float: left; font-size: 75%; font-style: normal; line-height: 1.25; margin: 0 1em 1em 0; }
header address p { margin: 0 0 0.25em; }
header span, header img { display: block; float: right; }
header span { margin: 0 0 1em 1em; max-height: 25%; max-width: 60%; position: relative; }
header img { max-height: 100%; max-width: 100%; filter: drop-shadow(0 2px 5px rgba(0, 0, 0, 0.7)); }
...
@page { margin: 0; }
	...
	<body>
            ...
            if (isset($_GET['id_reserva'])){ 
                ...
                $sentencia_select=$con->prepare("SELECT *FROM reserva WHERE id_reserva = '$id_reserva'");
                $sentencia_select->execute(array(':id_reserva'=>$id_reserva));
            ...
            /*$sql ="select * from reserva where id = 'id_reserva' ";
	...
	?>
		<header>
			<h1>RESORT HOUSE</h1>
			<address >
				<p>HOTEL RESORT HOUSE</p>
				<p>(+57) 65 222 44 55</p>
			</address>
			<span><img alt="" src="./assets/img/LogoC.png" width="50px" height="50px"></span>
		</header>
		<article>
			<h1>	Recipiente</h1>
			<address >
			...
			<table class="meta">
				<tr>
					...
					<td><span ><?php echo $id_reserva; ?></span></td>
				</tr>
				<tr>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						<td><span ><?php echo $TipoHabitacion; ?></span></td>
					...
					<tr>
						<td><span ><?php echo $comida; ?>  </span></td>
						<td><span ><?php echo $n_dias; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- resorthouse@mail.com || Web :- http://resorthouse/homepage || Phone :- +57 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
