<?php
	...
	$sentencia_select=$con->prepare('SELECT *FROM reserva WHERE (estado = "Sin Confirmar") ORDER BY id_reserva ASC');
...
<head>
    ...
    <title>Reservas | Por Confirmar</title>
    <!-- icons -->
                                        ...
                                        <table class="table table-striped custom-table table-hover">
                                            ...
                                            <?php foreach($resultado as $fila):?>
                                                <tr >
                                                    ...
                                                    <td><a href="reservasSolicitud.php?id_reserva=<?php echo $fila['id_reserva']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa fa-pencil"></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
                                            </tbody>
                                        </table>
