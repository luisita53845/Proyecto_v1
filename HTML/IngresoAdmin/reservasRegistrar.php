<?php 
	...
	if(isset($_POST['reservar'])){
		...
		if(!empty($Nombre) && !empty($telefono) && !empty($email) && !empty($TipoHabitacion) && !empty($Cant_personas) && !empty($comida) && !empty($parqueadero) && !empty($fecha_inicio) && !empty($fecha_fin) && !empty($n_dias) && !empty($estado) ){
			if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
				echo "<script> alert('Correo no valido');</script>";
			}else{
				$consulta_insert=$con->prepare('INSERT INTO reserva(Nombre,telefono,email,TipoHabitacion,Cant_personas, comida, parqueadero, fecha_inicio, fecha_fin, n_dias, estado) VALUES(:Nombre,:telefono,:email,:TipoHabitacion,:Cant_personas,:comida,:parqueadero,:fecha_inicio,:fecha_fin,:n_dias,:estado)');
...
<head>
    ...
    <title>Reservas | Registrar</title>
    <!-- icons -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-blue">
                                <div class="card-head">
                                    <header>REGISTRAR &nbsp;&nbsp;RESERVA</header>
                                </div>
                                <div class="card-body ">
											...
											<div class="">
												<div class="col-md-6 col-sm-6" style="text-align:center;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="TipoHabitacion" id="" style="width: 100%;" class="form-control">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="Cant_personas"  >
                                                    </div>
                                                    <div class="form-group">
														<label>Comidas</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Parqueadero</label><br>
                                                        <select name="parqueadero" id="" style="width: 100%; " class="form-control">
                                                            <option value="0"></option>
                                                    ...
                                                    <div class="form-group">
														...
														<input type="text" class="form-control" name="n_dias"  >
                                                    </div>
                                                    <div class="form-group">
														<label>Estado</label>
														<input type="text" class="form-control" name="estado" value="Sin Confirmar">
													</div>
												</div>
											</div></br>
											<div class="btn__group" style=" margin-left: 14%; " >
                                                <input type="submit" name="reservar" value="Reservar" class="btn btn-circle btn-success">
